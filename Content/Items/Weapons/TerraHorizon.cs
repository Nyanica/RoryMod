...
{
	public class TerraHorizon : ModItem
	{
		...
		public override void SetDefaults() {
            ...
            Item.SetWeaponValues(300, 6, 96);
            Item.shootSpeed *= 1.5f;

            Item.SetShopValues(ItemRarityColor.StrongRed10, 1000000000);

        }

        public override void AddRecipes()
        {
            Recipe recipe = Recipe.Create(ModContent.ItemType<TerraHorizon>(), 1);
